...
export const engineering: Post[] = [
    ...
    new Post('engineering', 'Lessons Learned', 'Lessons Learned', 'Liststhe most important lessons learned as senior software developer.', 'assets/posts/engineering/lessons-learned/lessons-learned.md', 'assets/posts/engineering/lessons-learned/thumbnail.png', '2024-11-30','/engineering/lessons-learned'), 
