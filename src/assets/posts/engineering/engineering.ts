...
export const engineering: Post[] = [
    ...
    new Post('engineering', 'Focus', 'Embracing the Terminal', 'Post is about outlining how a terminal can be used effectively.', 'assets/posts/engineering/embracing_the_terminal/embracing-the-terminal.md', 'assets/posts/engineering/embracing_the_terminal/thumbnail.svg', '2024-10-13','/engineering/embracing_the_terminal'), 
]